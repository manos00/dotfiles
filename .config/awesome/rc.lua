...
--              {description = "view next", group = "tag"}),
    ...
    awful.key({ modkey, "Shift"}, "b", 
    	function ()
		awful.util.spawn(scripts .. "dmenu/bookmarksmin.sh")
    	end,
    ...
    awful.key({ modkey }, "b", 
    	function () 
    		awful.util.spawn("min") 
    	end,
    {description = "Open minbrowser", group = "applications"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "c",      function (c) if not (string.match(tostring(c), "polybar")) then c:kill() end end,
